...
},{"random-seed":3}],5:[function(require,module,exports){
'use strict';
/* global Phaser */
...
},{"./states/boot.js":8,"./states/finish.js":9,"./states/menu.js":10,"./states/play.js":11,"./states/preload.js":12}],7:[function(require,module,exports){
...
Play.prototype = {
	...
	draw: {
		plus: function(graphics, x, y, size) {
			...
			/*graphic.drawPolygon([
				new Phaser.Point(x - size / 6, y - size / 2),
				new Phaser.Point(x + size / 6, y - size / 2),
				new Phaser.Point(x + size / 6, y - size / 6),
				new Phaser.Point(x + size / 2, y - size / 6),
				new Phaser.Point(x + size / 2, y + size / 6),
				new Phaser.Point(x + size / 6, y + size / 6),
				new Phaser.Point(x + size / 6, y + size / 2),
				new Phaser.Point(x - size / 6, y + size / 2),
	...
	redrawPointer: function() {
		...
		//this.pointer.beginFill(0x000000);
		//this.pointer.drawRect(0, 0, this.tileSize - width, width);
		//this.pointer.drawRect(this.tileSize - width, 0, width, this.tileSize);
		//this.pointer.drawRect(width, this.tileSize - width, this.tileSize - width, width);
		//this.pointer.drawRect(0, width, width, this.tileSize - width);
		
		width = 24;
		
		if (this.position.x < this.levelConfig.sizeX - 1) {
			/*this.pointer.drawPolygon([
				new Phaser.Point(this.tileSize - width, this.tileSize / 2 - width),
				new Phaser.Point(this.tileSize, this.tileSize / 2 - width),
				new Phaser.Point(this.tileSize + width, this.tileSize / 2),
				new Phaser.Point(this.tileSize, this.tileSize / 2 + width),
				new Phaser.Point(this.tileSize - width, this.tileSize / 2 + width)
			]);*/
			this.draw.plus(this.pointer, this.tileSize, this.tileSize / 2, 16);
			//this.pointer.drawRect(this.tileSize - width, (this.tileSize) / 2 - width, 2 * width, 2 * width);
		}
		
		if (this.position.x > 0) {
			/*this.pointer.drawPolygon([
				new Phaser.Point(width, this.tileSize / 2 - width),
				new Phaser.Point(0, this.tileSize / 2 - width),
				new Phaser.Point(- width, this.tileSize / 2),
				new Phaser.Point(0, this.tileSize / 2 + width),
				new Phaser.Point(width, this.tileSize / 2 + width)
			]);*/
			this.draw.plus(this.pointer, 0, this.tileSize / 2, 16);
			//this.pointer.drawRect(- width, (this.tileSize) / 2 - width, 2 * width, 2 * width);
		}
		
		if (this.position.y < this.levelConfig.sizeY - 1) {
			//this.pointer.drawRect((this.tileSize) / 2 - width, this.tileSize - width, 2 * width, 2 * width);
			this.draw.multiply(this.pointer, this.tileSize / 2, this.tileSize, 16);
		}
		
		if (this.position.y > 0) {
			//this.pointer.drawRect((this.tileSize) / 2 - width, - width, 2 * width, 2 * width);
...
module.exports = Play;
},{"./../components/board.js":4,"./../components/label_button.js":5,"./../mathmaze/bot.js":7,"lodash":2}],12:[function(require,module,exports){
'use strict';
